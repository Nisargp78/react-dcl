        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-12">
            ...
            <div className="mt-8 flex items-center justify-between border-t border-gray-200 pt-6">
              ...
              <button className="rounded-xl bg-blue-600 px-6 py-3 font-bold text-white shadow-md transition duration-300 hover:-translate-y-1 hover:bg-blue-700 hover:shadow-lg" onClick={() => {addToCart}}>
                Enroll Now
              </button>
            </div>
          </div>
